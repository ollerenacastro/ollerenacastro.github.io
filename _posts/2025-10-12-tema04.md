...
---
**LINKS DE LA GRABACIÓN DE LA CLASE**: [Clase 07](https://drive.google.com/file/d/1YYbr7nou8q3PIKASmrij3iEEgYlZyWFl/view) - 28/06/2026
...
#### **🎯 Tarea: Investigación de TTPs — OilRig (APT34)**

Para cada TTP listado a continuación, consulta la base de datos oficial [MITRE ATT&CK](https://attack.mitre.org) y elabora un reporte con el siguiente formato:

| Campo | Qué debes responder |
| ----- | ------------------- |
| **Descripción** | ¿Qué es esta técnica? ¿Qué capacidad otorga al atacante? |
| **Ejecución** | ¿Cómo se ejecuta? Pasos, herramientas, comandos o condiciones necesarias |
| **Producto** | ¿Qué obtiene o logra el atacante al ejecutarla exitosamente? |

Completa el formato para cada uno de los siguientes TTPs utilizados por OilRig en esta campaña:
...
> **Recurso oficial:** <https://attack.mitre.org/techniques/>
